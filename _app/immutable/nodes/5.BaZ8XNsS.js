...
<span class="line"><span style="color:#E1E4E8">)</span></span></code></pre> <p>later on you will need to copy some assets from your project to your build folder. This can be done by appending the following at the end of your CMakeLists.txt</p> <pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#F97583">set</span><span style="color:#E1E4E8">(SHADERS_FOLDER </span><span style="color:#9ECBFF">"$&#123;CMAKE_SOURCE_DIR&#125;/Shaders"</span><span style="color:#E1E4E8">)</span></span>
...
<span class="line"><span style="color:#E1E4E8">&#125;</span></span></code></pre> <p>Remember to run all the following commands inside the project root folder</p> <p>Then we need to tell CMake what preset we are gonna be using with</p> <pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#6A737D"># instead of release-windows you can use any preset</span></span>
<span class="line"><span style="color:#B392F0">cmake</span><span style="color:#79B8FF"> -S</span><span style="color:#9ECBFF"> .</span><span style="color:#79B8FF"> --preset</span><span style="color:#9ECBFF"> release-windows</span></span></code></pre> <!> <p>And as the last command you just need to run</p> <pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#B392F0">cmake</span><span style="color:#79B8FF"> --build</span><span style="color:#9ECBFF"> build</span></span></code></pre> <p>Now in your generated <code>build/</code> directory you will see an executable called <code>MyProject.exe</code> or <code>MyProject</code>. Running it from inside the build folder will run your project</p> <!>`,1);function b(y){var c=C(),r=e(d(c),2);t(r,{children:(s,o)=>{l();var a=p("on Linux you may have some issues if using wayland/X11 as it does not like the default glfw library. You would have to modify the CMakeLists.txt a bit for it to work");n(s,a)}});var E=e(r,56);h(E,{children:(s,o)=>{l();var a=p("this example expects you to have a mingw compiler installed on windows!");n(s,a)}});var i=e(E,28);t(i,{children:(s,o)=>{l();var a=p('If you have not set VCPKG as your environment variable you will also need to add an argument like `-DCMAKE_TOOLCHAIN_FILE="/PATH/TO/VCPKG/CMAKE/vcpkg.cmake"`');n(s,a)}});var F=e(i,8);t(F,{children:(s,o)=>{l();var a=p("Editors like VS Code have packages that can manage commands like building and selecting a preset or execution of code for you");n(s,a)}}),n(y,c)}export{b as component};
