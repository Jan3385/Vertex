...
<span class="line"><span style="color:#F97583">endif</span><span style="color:#E1E4E8">()</span></span></code></pre></div> <!>`,1);function u(n){var s=E(),l=p(t(s),8);y(l,{children:(e,d)=>{c();var o=i("This will make the executable run on your specific system. To ensure that it runs on any Linux desktop instance you need to have both X11 and Wayland packages");a(e,o)}}),a(n,s)}export{u as component};
